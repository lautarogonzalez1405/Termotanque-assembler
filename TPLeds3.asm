;******************************************************************
;TP FINAL - EJERCICIO 2 - PUNTO 3
;PROGRAMA PARA ENCENDER 4 LEDS POR UN SEGUNDO Y APAGARLOS POR MEDIO SEGUNDO
;ESTE PROGRAMA ES IDENTICO AL PUNTO DOS PERO
;CON UN PEQUEÑO CAMBIO EN EL Delay3
;******************************************************************
...
RutinaConfig:
	movlw	   d'127'		  ;
	movwf	   Delay1 		  ;
	movlw	   d'186'		  ; Rutina de inicio donde los registros Delay se cargan con los valores
	movwf	   Delay2		  ; necesarios para generar el retardo deseado
	movlw	   d'14'		  ;
	movwf	   Delay3		  ;
...
LoopEncendido:		  ; Crear subrutina LoopEncendido
	 ...
	 decfsz	   Delay3,f		  ;	Idem linea 43
	 goto	   LoopEncendido  ;	{[(3*127+1)*186+3*186+1]*14+3*14+1} * 1uS = 1.002.597uS (Un segundo aprox)
	 movlw	   d'7'
	 movwf	   Delay3		  ; Se vuelve a cargar Delay3 pero esta vez con valor 7 para que el LoopApagado tome medio segundo
